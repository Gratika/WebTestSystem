...
public class JwtTokenProvider {
    ...
    //отримати логін з jwt token
    public String getUsernameFromToken(String token) {
        return getClaimFromToken(token, Claims::getSubject);
    }
    //отримати термін дії з jwt token
    ...
    //для отримання будь-якої інформації з токена нам знадобиться секретний ключ
